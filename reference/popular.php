...
<div class="href_path_link"><h6>YOU ARE HERE: <a href="blog.php">HOME</a>>POPULAR</h6></div>
<div class="href_path_about"><h2>most popular Happy Moment</h2></div>
...
else
{
    ...
    $result = mysqli_query($con, "SELECT * FROM (SELECT COUNT(c.id) ct, n.date, n.note_id, n.topic, n.text, n.userid 
    FROM Notes n LEFT JOIN comment c ON n.note_id = c.noteid GROUP BY n.note_id) AS t1 JOIN person p ON t1.userid = p.personid ORDER BY ct DESC LIMIT $page, 20;");
...
<?php
	...
	<ul class="widgetTabs tabs-nav">
		...
		<li class="latest"><a href="#tab-latest">Happiest</a></li>
	</ul>
